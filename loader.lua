--[[
    Skelly Hub Loader v1.0
    Skeleton Theme - Clean & Dark
...
container.Size = UDim2.new(0, 380, 0, 400)
container.Position = UDim2.new(0.5, -190, 0.5, -200)
...
-- Skeleton Icon (Text-based)
local skeletonIcon = Instance.new("TextLabel")
skeletonIcon.Size = UDim2.new(0, 40, 0, 40)
skeletonIcon.Position = UDim2.new(0.05, 0, 0.15, 0)
skeletonIcon.BackgroundTransparency = 1
skeletonIcon.Text = "💀"
skeletonIcon.TextColor3 = Color3.fromRGB(200, 200, 200)
skeletonIcon.TextSize = 32
skeletonIcon.Font = Enum.Font.Gotham
skeletonIcon.Parent = header

-- Logo Text
local logoText = Instance.new("TextLabel")
logoText.Size = UDim2.new(0.7, 0, 0, 35)
logoText.Position = UDim2.new(0.18, 0, 0.05, 0)
logoText.BackgroundTransparency = 1
logoText.Text = "SKELLY HUB"
...
subtitle.Position = UDim2.new(0.18, 0, 0.5, 0)
...
divider.Position = UDim2.new(0.075, 0, 0.18, 0)
...
keyLabel.Position = UDim2.new(0.1, 0, 0.23, 0)
...
activateBtn.Position = UDim2.new(0.1, 0, 0.43, 0)
