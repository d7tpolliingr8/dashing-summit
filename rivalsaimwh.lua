...
local function _0xsb()
    ...
    pcall(function()
        ...
        if _0xgp then _0xgp:ApplyTheme("RavenCheats") end
    end)
end
...
local _0xtc = {
    ESP = {
        On = false, MaxDist = 1000, Skel = true, SkelColor = _0xox,
        Names = true, NameColor = _0xox, Dist = true, DistColor = _0xqz,
        HP = true, Tracers = false, TraceColor = _0xox,
        Chams = true, ChamsColor = _0xlu, ChamsTrans = 0.4, ChamsOut = _0xpy,
        Box = false, BoxColor = _0xox, CornerBox = false, CornerColor = _0xox,
        OffscreenArrows = false, OffscreenArrowColor = _0xox,
    },
    Aim = {
        On = false, Part = "Head", FOV = 200, ShowFOV = true,
        FOVColor = _0xox, Smoothness = 0.3, YOffset = 0,
        Prediction = 0.5, WallCheck = false, AimKey = "MouseButton2",
        MaxDistance = 500,
    },
    Visuals = {
        FullBright = false, NoFog = false, Crosshair = false,
        CrosshairColor = _0xnw, CrosshairSize = 12, CrosshairGap = 4,
        CrosshairSpinSpeed = 2.0, ThirdPerson = false, ThirdPersonDistance = 10,
    },
    Movement = {
        Fly = false, FlySpeed = 50, Noclip = false,
        FlyKeybind = Enum.KeyCode.F, SpeedHack = false, SpeedValue = 24,
    },
    TargetUtility = {
        StickyTP = false, SelectedTarget = "None", HeightOffset = 5, TeamCheck = true,
    }
}
...
local function _0xgp6(_0xhq7)
    ...
    if not _0xtc.TargetUtility.TeamCheck then return false end
    if _0xdm.Team and _0xhq7.Team and _0xdm.Team == _0xhq7.Team then return true end
    if _0xdm.TeamColor and _0xhq7.TeamColor and _0xdm.TeamColor == _0xhq7.TeamColor then return true end
    if _0x8h then
...
local function _0xnw1()
    for _, _0xox2 in ipairs(_0x1a:GetPlayers()) do
        ...
        if _0xgp6(_0xox2) then continue end
...
local function _0xnw7()
    for _, _0xox8 in ipairs(_0x1a:GetPlayers()) do
        ...
        if _0xgp6(_0xox8) then continue end
        _0xhq9(_0xox8)
...
local function _0xyh4(_0xzi5)
    if _0xtc.Aim.Part == "Head" then return _0xzi5:FindFirstChild("Head") end
    if _0xtc.Aim.Part == "HumanoidRootPart" then return _0xzi5:FindFirstChild("HumanoidRootPart") end
    if _0xtc.Aim.Part == "UpperTorso" then return _0xzi5:FindFirstChild("UpperTorso") end
...
_0x2b.RenderStepped:Connect(function()
    ...
    if _0xtc.Visuals.ThirdPerson then _0xyh() end
end)
...
local function _0xgp0()
    ...
    if _0xjs3 then _0xjs3.PlatformStand = true end
    _0xen8 = _0x2b:BindToRenderStep("FlySystem", Enum.RenderPriority.Last.Value, function()
        if not _0xfo9 then _0xkt4(); return end
        ...
        if _0x3c:IsKeyDown(Enum.KeyCode.W) then _0xpy9 = _0xpy9 + _0xmv6 end
        if _0x3c:IsKeyDown(Enum.KeyCode.S) then _0xpy9 = _0xpy9 - _0xmv6 end
        if _0x3c:IsKeyDown(Enum.KeyCode.A) then _0xpy9 = _0xpy9 - _0xnw7 end
        if _0x3c:IsKeyDown(Enum.KeyCode.D) then _0xpy9 = _0xpy9 + _0xnw7 end
        if _0x3c:IsKeyDown(Enum.KeyCode.Space) then _0xpy9 = _0xpy9 + _0xox8 end
        if _0x3c:IsKeyDown(Enum.KeyCode.LeftShift) then _0xpy9 = _0xpy9 - _0xox8 end
...
local function _0xkt4()
    ...
    if _0xqz0 then
        ...
        if _0xra1 then _0xra1.PlatformStand = false end
        local _0xsb2 = _0xqz0:FindFirstChild("HumanoidRootPart")
        if _0xsb2 then _0xsb2.Velocity = Vector3.new(0, 0, 0) end
    end
end
...
local function _0xzi9()
    ...
    _0xyh8 = _0x2b:BindToRenderStep("NoclipSystem", Enum.RenderPriority.Last.Value, function()
        if not _0xtc.Movement.Noclip then _0xaj0(); return end
...
-- ESP Tab
local _0xmv8 = _0xlu7.ESP:AddLeftGroupbox("ESP Controls")
_0xmv8:AddToggle("ESPOn", { Text = "Enable", Default = _0xtc.ESP.On })
Toggles.ESPOn:OnChanged(function(v) _0xtc.ESP.On = v end)

_0xmv8:AddSlider("ESPDist", { Text = "Max Dist", Default = _0xtc.ESP.MaxDist, Min = 50, Max = 5000, Rounding = 0 })
Options.ESPDist:OnChanged(function(v) _0xtc.ESP.MaxDist = v end)

_0xmv8:AddToggle("ESPSkel", { Text = "Skeleton", Default = _0xtc.ESP.Skel })
...
_0xmv8:AddToggle("ESPChams", { Text = "Chams", Default = _0xtc.ESP.Chams })
...
_0xmv8:AddToggle("ESPOffscreen", { Text = "Arrows", Default = _0xtc.ESP.OffscreenArrows })
...
-- Aim Tab
local _0xnw9 = _0xlu7.Aim:AddLeftGroupbox("Aimbot Controls")
_nw9:AddToggle("AimOn", { Text = "Enable", Default = _0xtc.Aim.On })
...
Options.AimKeyPicker:OnChanged(function(v) _0xtc.Aim.AimKey = Options.AimKeyPicker.Value end)

_nw9:AddToggle("AimWall", { Text = "Wall Check", Default = _0xtc.Aim.WallCheck })
Toggles.AimWall:OnChanged(function(v) _0xtc.Aim.WallCheck = v end)

_nw9:AddDropdown("AimPart", { Values = {"Head", "HumanoidRootPart", "UpperTorso"}, Default = 1, Text = "Hitbox" })
Options.AimPart:OnChanged(function(v) _0xtc.Aim.Part = v end)

_nw9:AddToggle("ShowFOV", { Text = "Show FOV", Default = _0xtc.Aim.ShowFOV })
...
_nw9:AddSlider("AimFOV", { Text = "FOV Radius", Default = _0xtc.Aim.FOV, Min = 10, Max = 800, Rounding = 0 })
Options.AimFOV:OnChanged(function(v) _0xtc.Aim.FOV = v end)

_nw9:AddSlider("AimSmooth", { Text = "Smooth", Default = _0xtc.Aim.Smoothness, Min = 0, Max = 1, Rounding = 2 })
Options.AimSmooth:OnChanged(function(v) _0xtc.Aim.Smoothness = v end)

_nw9:AddSlider("AimPred", { Text = "Prediction", Default = _0xtc.Aim.Prediction, Min = 0, Max = 2, Rounding = 2 })
Options.AimPred:OnChanged(function(v) _0xtc.Aim.Prediction = v end)

-- Utils Tab
local _0xox0 = _0xlu7.Util:AddLeftGroupbox("Target Teleportation")
_ox0:AddDropdown("TargetDropdown", { Values = _0xwf4(), Default = 1, Text = "Target", Multi = false })
Options.TargetDropdown:OnChanged(function(v) _0xtc.TargetUtility.SelectedTarget = v end)

_ox0:AddButton("Refresh List", function()
...
_ox0:AddSlider("HeightOffsetSlider", { Text = "Height Offset", Default = _0xtc.TargetUtility.HeightOffset, Min = 0, Max = 20, Rounding = 1 })
Options.HeightOffsetSlider:OnChanged(function(v) _0xtc.TargetUtility.HeightOffset = v end)

_ox0:AddToggle("StickyTP", { Text = "Enable TP", Default = _0xtc.TargetUtility.StickyTP })
Toggles.StickyTP:OnChanged(function(v) _0xtc.TargetUtility.StickyTP = v end)

-- Team Check
local _0xpy1 = _0xlu7.Util:AddRightGroupbox("Team Settings")
_py1:AddToggle("TeamCheckToggle", {
...
-- Unlock All
local _0xqz2 = _0xlu7.Util:AddRightGroupbox("Unlock All")
_qz2:AddButton("UNLOCK ALL", function()
    _0x6f:SetCore("SendNotification", {
        Title = "Raven Cheats",
        Text = "Starting Unlock All... Please wait.",
        Duration = 2,
    })
    task.spawn(function() _0xkt0() end)
end)

-- Move Tab
local _0xra3 = _0xlu7.Move:AddLeftGroupbox("Locomotion Controls")
_ra3:AddToggle("FlyToggle", { Text = "Flight", Default = _0xtc.Movement.Fly })
Toggles.FlyToggle:OnChanged(function(v)
    if _0xfo9 ~= v then _0xtc3() end
end)
Toggles.FlyToggle:AddKeyPicker("FlyKeybindPicker", { Default = "F", Text = "Flight Hotkey", NoUI = false })
Options.FlyKeybindPicker:OnChanged(function(v) _0xtc.Movement.FlyKeybind = Options.FlyKeybindPicker.Value end)

_ra3:AddSlider("FlySpeed", { Text = "Flight Speed", Default = _0xtc.Movement.FlySpeed, Min = 10, Max = 300, Rounding = 0 })
Options.FlySpeed:OnChanged(function(v) _0xtc.Movement.FlySpeed = v end)

_ra3:AddToggle("SpeedToggle", { Text = "Speed Hack", Default = _0xtc.Movement.SpeedHack })
Toggles.SpeedToggle:OnChanged(function(v) _0xtc.Movement.SpeedHack = v end)

_ra3:AddSlider("SpeedVal", { Text = "Speed Factor", Default = _0xtc.Movement.SpeedValue, Min = 16, Max = 100, Rounding = 0 })
Options.SpeedVal:OnChanged(function(v) _0xtc.Movement.SpeedValue = v end)

_ra3:AddToggle("NoclipToggle", { Text = "Noclip", Default = _0xtc.Movement.Noclip })
...
-- Visuals Tab
local _0xsb4 = _0xlu7.Vis:AddLeftGroupbox("Environment & Crosshair")
_sb4:AddToggle("FullBright", { Text = "Fullbright", Default = _0xtc.Visuals.FullBright })
Toggles.FullBright:OnChanged(function(v) _0xtc.Visuals.FullBright = v end)

_sb4:AddToggle("NoFog", { Text = "No Fog", Default = _0xtc.Visuals.NoFog })
Toggles.NoFog:OnChanged(function(v) _0xtc.Visuals.NoFog = v end)

_sb4:AddToggle("ThirdPerson", {
    Text = "Third Person",
...
Toggles.ThirdPerson:OnChanged(function(v)
    ...
    _0xud = v
    if v then _0xgx() else _0xgx() end
end)

_sb4:AddSlider("ThirdPersonDist", {
    Text = "Distance",
...
_sb4:AddToggle("CrosshairToggle", { Text = "Crosshair", Default = _0xtc.Visuals.Crosshair })
...
_sb4:AddSlider("CrosshairSize", { Text = "Length", Default = _0xtc.Visuals.CrosshairSize, Min = 4, Max = 30, Rounding = 0 })
Options.CrosshairSize:OnChanged(function(v) _0xtc.Visuals.CrosshairSize = v end)

_sb4:AddSlider("CrosshairGap", { Text = "Spacing", Default = _0xtc.Visuals.CrosshairGap, Min = 1, Max = 15, Rounding = 0 })
Options.CrosshairGap:OnChanged(function(v) _0xtc.Visuals.CrosshairGap = v end)

_sb4:AddSlider("CrosshairSpin", { Text = "Spin Speed", Default = _0xtc.Visuals.CrosshairSpinSpeed, Min = 0.1, Max = 5, Rounding = 1 })
...
_0xgp:ApplyToTab(_0xlu7.Settings)
_0xfo:BuildConfigSection(_0xlu7.Settings)
